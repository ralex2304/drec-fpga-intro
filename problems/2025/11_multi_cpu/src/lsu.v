...
assign o_mem_rden = i_rd_en;
assign o_mem_wen  = i_wr_en;
...
wire [7:0]  rd_data8  = i_mem_data[offset_d   +:8];
wire [15:0] rd_data16 = i_mem_data[offset_d[1]+:16];
